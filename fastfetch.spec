...
Version  : 2.29.0
Release  : 18
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.29.0/fastfetch-2.29.0.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.29.0/fastfetch-2.29.0.tar.gz
...
%prep
%setup -q -n fastfetch-2.29.0
cd %{_builddir}/fastfetch-2.29.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730734252
mkdir -p clr-build
pushd clr-build
