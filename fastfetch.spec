...
Version  : 2.18.1
Release  : 3
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.18.1/fastfetch-2.18.1.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.18.1/fastfetch-2.18.1.tar.gz
...
%prep
%setup -q -n fastfetch-2.18.1
cd %{_builddir}/fastfetch-2.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720708373
mkdir -p clr-build
pushd clr-build
