...
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.25.0/fastfetch-2.25.0.tar.gz
...
%prep
%setup -q -n fastfetch-2.25.0
cd %{_builddir}/fastfetch-2.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726760093
mkdir -p clr-build
pushd clr-build
