...
Version  : 2.40.3
Release  : 21
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.40.3/fastfetch-2.40.3.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.40.3/fastfetch-2.40.3.tar.gz
...
%prep
%setup -q -n fastfetch-2.40.3
cd %{_builddir}/fastfetch-2.40.3
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744041790
mkdir -p clr-build
pushd clr-build
