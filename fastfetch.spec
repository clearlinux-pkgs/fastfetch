...
Version  : 2.30.1
Release  : 19
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.30.1/fastfetch-2.30.1.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.30.1/fastfetch-2.30.1.tar.gz
...
%prep
%setup -q -n fastfetch-2.30.1
cd %{_builddir}/fastfetch-2.30.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731943705
mkdir -p clr-build
pushd clr-build
