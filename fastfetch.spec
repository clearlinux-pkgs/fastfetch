...
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.48.1/fastfetch-2.48.1.tar.gz
...
%prep
%setup -q -n fastfetch-2.48.1
cd %{_builddir}/fastfetch-2.48.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752850469
mkdir -p clr-build
pushd clr-build
