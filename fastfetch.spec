...
Version  : 2.45.0
Release  : 27
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.45.0/fastfetch-2.45.0.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.45.0/fastfetch-2.45.0.tar.gz
...
%prep
%setup -q -n fastfetch-2.45.0
cd %{_builddir}/fastfetch-2.45.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749225232
mkdir -p clr-build
pushd clr-build
...
/usr/share/package-licenses/fastfetch/504ae60d5617bf04284b5ea8b349a311a3516c08
