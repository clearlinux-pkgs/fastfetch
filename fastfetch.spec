...
Version  : 2.44.0
Release  : 26
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.44.0/fastfetch-2.44.0.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.44.0/fastfetch-2.44.0.tar.gz
...
%prep
%setup -q -n fastfetch-2.44.0
cd %{_builddir}/fastfetch-2.44.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748010164
mkdir -p clr-build
pushd clr-build
