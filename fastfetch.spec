...
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.22.0/fastfetch-2.22.0.tar.gz
...
%prep
%setup -q -n fastfetch-2.22.0
cd %{_builddir}/fastfetch-2.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724647495
mkdir -p clr-build
pushd clr-build
