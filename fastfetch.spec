...
Version  : 2.43.0
Release  : 25
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.43.0/fastfetch-2.43.0.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.43.0/fastfetch-2.43.0.tar.gz
...
%prep
%setup -q -n fastfetch-2.43.0
cd %{_builddir}/fastfetch-2.43.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747233670
mkdir -p clr-build
pushd clr-build
