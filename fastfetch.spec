...
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.27.1/fastfetch-2.27.1.tar.gz
...
%prep
%setup -q -n fastfetch-2.27.1
cd %{_builddir}/fastfetch-2.27.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728421199
mkdir -p clr-build
pushd clr-build
