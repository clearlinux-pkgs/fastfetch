...
Version  : 2.40.2
Release  : 20
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.40.2/fastfetch-2.40.2.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.40.2/fastfetch-2.40.2.tar.gz
...
%prep
%setup -q -n fastfetch-2.40.2
cd %{_builddir}/fastfetch-2.40.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743783679
mkdir -p clr-build
pushd clr-build
