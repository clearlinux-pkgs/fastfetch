...
Version  : 2.26.1
Release  : 15
URL      : https://github.com/fastfetch-cli/fastfetch/archive/2.26.1/fastfetch-2.26.1.tar.gz
Source0  : https://github.com/fastfetch-cli/fastfetch/archive/2.26.1/fastfetch-2.26.1.tar.gz
...
%prep
%setup -q -n fastfetch-2.26.1
cd %{_builddir}/fastfetch-2.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727714748
mkdir -p clr-build
pushd clr-build
